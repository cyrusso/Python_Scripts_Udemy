...
# Enter this command: python NetMon_SQL_v1.py NETWORK_IP.txt SSH_USERPASS.txt SQL_CONN.txt # Check the console output and SQL_Error_Log.txt file for any errors.
...
def upint_total():
    try:
        ...
        sql_connection("INSERT INTO UPEthInterfaces(NetworkUPEthIntfPercent,Top3EthIntf,PollTimestamp) VALUES(%s, %s, %s)", (upint, top3_list, poll_timestamp))
    except ZeroDivisionError:
        print "* There was an error while computing a network parameter. No record has been added to MySQL. Please retry."
